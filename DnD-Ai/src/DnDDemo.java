...
class DnDDemo implements ActionListener
  {  
   JLabel displayLabel;
   JButton nextButton;
   JButton prevButton;
   ...
   Thread executionThread;
     ...
     {  
      try
        {
         autoResources = ResourceBundle.getBundle("resources.DnDResources",Locale.getDefault());
        }
      ...
      JFrame jfrm = new JFrame(autoResources.getString("DnDDemo"));
      ...
      restartButton = new JButton(autoResources.getString("Restart"));
   ...
   private void nextUIState() throws Exception
     {
      ...
      else if (fv.getFactSlot("state").toString().equals("between"))
      {
       nextButton.setActionCommand("Next");
       nextButton.setText(autoResources.getString("Next"));
       restartButton.setActionCommand("Restart");
       restartButton.setText(autoResources.getString("Restart"));
       prevButton.setVisible(true);
